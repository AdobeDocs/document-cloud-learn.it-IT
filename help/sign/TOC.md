...
+ Attività avanzate {#advanced-tasks}
   ...
   + Invio {#advanced-tasks-sending}
      ...
      + [Gestione dei dati del modulo](sign-advanced-users/manage-form-data.md)
...
+ Settori e dipartimenti {#expand}
   ...
   + Esempi di utilizzo {#recipes}
      ...
      + Education {#edu}
         + [Applicazione per stage di moduli web Education](sign-usecase/usecase-edu-intern.md)
         + [Creazione di un&#39;applicazione di tirocinio per moduli web Education](sign-usecase/usecase-edu-intern-create.md)
