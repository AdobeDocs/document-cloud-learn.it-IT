...
+ Guida introduttiva {#get-started}
  ...
  + Lavora in modo più intelligente con l&#39;IA {#ai}
    ...
    + [Creare un podcast](getting-started/podcast.md)
...
+ Casi di utilizzo {#use-cases}
  ...
  + Area di attività {#lob}
    ...
    + Risorse umane {#hr}
      + [Panoramica](use-cases/lob/hr/hr-overview.md)
      + [Dall’analisi all’impatto: semplifica i flussi di lavoro di onboarding](use-cases/lob/hr/hr-insights.md)
    + IT {#it}
      + [Panoramica](use-cases/lob/it/it-overview.md)
      + [Abilitazione IT senza colli di bottiglia](use-cases/lob/it/it-enablement.md)
    + Legale {#legal}
    ...
    + Vendite {#sales}
      ...
      + [Trasformare l&#39;intelligenza dei clienti in risorse di vendita vincenti](use-cases/lob/sales/sales-insights.md)
