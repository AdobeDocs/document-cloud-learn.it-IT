...
+ Guida introduttiva {#get-started}
   ...
   + Lavora in modo più intelligente con l&#39;IA {#ai}
...
+ Serie di accessibilità {#accessibility-tutorials}
   + [Panoramica](accessibility-series/accessibility-overview.md)
   ...
   + [Creazione di un PDF accessibile in Acrobat](accessibility-series/accessible-acrobat.md)
   + [Nozioni di base sui tag](accessibility-series/basics-tagging.md)
   + [Documenti scansionati](accessibility-series/scanned-documents.md)
   + [Creare moduli accessibili](accessibility-series/create-accessible-forms.md)
   + [Elenchi complessi](accessibility-series/complex-lists.md)
   + [Tabelle complesse](accessibility-series/complex-tables.md)
...
+ Basato su IA {#ai-powered}
   ...
   + [Scopri gli approfondimenti di PDF con l’Assistente AI](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/ai/ai-assistant)
   + [Aumentare l&#39;efficienza del team con PDF Spaces](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/ai/pdf-spaces-legal)
   + [Cos’è Acrobat Studio?](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/ai/acrobat-studio)
